...
class GUI:
    ...
    def display_name_section(self):
        ...
        self.join_button = Button(frame,background='blue',bg="#ED8A09", text="Join", width=10, command=self.on_join).pack(side='left')
...
if __name__ == '__main__':
    root = Tk()
    root.configure(background='#6EE11F')
    gui = GUI(root)
